...
def select_file_popup(files):
    ...
    selection_window.title("Sélection de fichier")
    selection_window.geometry("700x300")  # Augmenter la taille de la fenêtre

    label = tk.Label(selection_window, text="Plusieurs fichiers trouvés. Veuillez sélectionner celui à utiliser:")
    label.pack(pady=10)
    ...
    select_button = ttk.Button(selection_window, text="Sélectionner", command=lambda: on_select(None))
